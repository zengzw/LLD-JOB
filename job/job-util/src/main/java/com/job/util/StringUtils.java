...
public class StringUtils {
     ...
     * @return
     */
    public  static String arraysToString(Object[] theAray, String delimiter) {
        if(theAray == null){
            return "";
        }
     ...
     * @return
     */
    public  static Long[] stringArrayToLongArray(String[] params) {
        if(params == null || params.length <= 0){
            return new Long[]{};
        }

        Long[] longCityids = new Long[params.length];
        for(int i = 0; i<params.length; i++){
            longCityids[i] = Long.parseLong(params[i]);
        }
